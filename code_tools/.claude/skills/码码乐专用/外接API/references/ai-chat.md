...
| **大模型卡片流式** | `POST api/app/zjAi/myShowStreamCard` |
| **文生文接口** | `POST api/app/zjAi/myOpenAiStream` |
| **ChatGPT 直接调用** | `POST api/app/chatGpt/prompt` |

> [!NOTE]
> `myShowStreamCard` 请求示例: `{"applicationId":"466...","question":"你好","content":[{"type":"text","text":"你好"}],"contentType":"object_string","conversationId":null,"tip":"","aiTaskId":""}`
> `myOpenAiStream` 请求示例: `{"model":"DeepSeek-V3", "messages":[{"role":"system","content":"..."},{"role":"user","content":"..."}]}`
