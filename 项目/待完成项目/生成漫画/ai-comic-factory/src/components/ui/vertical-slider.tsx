...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ref={ref}
    className={cn(
      "relative flex flex-col h-full w-full touch-none select-none items-center",
      className
    )}
    {...props}
  >
    <SliderPrimitive.Track className="relative w-4 grow overflow-hidden rounded-full bg-stone-300/50 dark:bg-stone-700/50 backdrop-blur-sm border border-white/20">
